...
const runOnce = function () {
  console.log('This will run always when called');
};

// IIFE
(function () {
  console.log('This will never run again');
  // const isPrivate = 77; // local variable
})();

(() => console.log(`this will ALSO never run again`))();

// console.log(isPrivate); // is not defined in global scope
...
// console.log(isPrivate); // is not defined in global scope
console.log(notPrivate); // 154, as it is declared using 'var'
...
console.dir(booker); // [[Scopes]] => Closure (secureBooking)
*/
